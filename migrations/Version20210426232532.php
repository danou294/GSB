 ...
 */
final class Version20210426232532 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE medicament (id_medicament INT AUTO_INCREMENT NOT NULL, med_depotlegal INT NOT NULL, med_nomcommercial VARCHAR(25) NOT NULL, med_composition VARCHAR(255) NOT NULL, med_effets VARCHAR(255) NOT NULL, med_contreindic VARCHAR(255) DEFAULT NULL, med_prixechantillon DOUBLE PRECISION NOT NULL, fam_code INT NOT NULL, image VARCHAR(255) NOT NULL, INDEX fam_code (fam_code), PRIMARY KEY(id_medicament)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
